...
const Card = ({myData})=> {
    ...
    useEffect(() => {
        ...
        const result = await prominent(item.sprites.front_default, { amount: 4, format: 'hex' });
    ...
    return (
        ...
        <div key={item.id} className="flex flex-col items-center justify-center  mt-5" >
            <div onClick={()=>handleItemClick(item)} className="relative flex flex-col  align-middle cursor-pointer w-96 p-5 hover:-translate-y-1 duration-300" style={
                ...
                <path d="M21.9012 13H16.8506C16.3873 15.2822 14.3696 17 11.9506 17C9.53167 17 7.51391 15.2822 7.05064 13H2C2.50172 18.0533 6.76528 22 11.9506 22C17.136 22 21.3995 18.0533 21.9012 13Z" fill={colors[item.id] && colors[item.id][1]} stroke="black" strokeWidth="0.5" />
                ...
                <div className="w-full h-full mb-10  absolute flex-col bottom-[-47px] left-[20px]">
